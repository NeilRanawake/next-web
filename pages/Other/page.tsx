...
const otherBooks = books.filter((book) => book.genre.includes("Other"));
...
//function page() {
  ...
  const [filteredBooks, setFilteredBooks] = useState(otherBooks);

  useEffect(() => {
    console.log("searchTerm:", searchTerm);
    const filtered = otherBooks.filter((book) => {
