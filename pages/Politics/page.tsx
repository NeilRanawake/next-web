...
const politicsBooks = books.filter((book) => book.genre.includes("Politics"));
...
//function page() {
  ...
  const [filteredBooks, setFilteredBooks] = useState(politicsBooks);

  useEffect(() => {
    console.log("searchTerm:", searchTerm);
    const filtered = politicsBooks.filter((book) => {
