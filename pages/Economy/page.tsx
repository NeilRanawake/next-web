...
const economyBooks = books.filter((book) => book.genre.includes("Economy"));
...
//function page() {
  ...
  const [filteredBooks, setFilteredBooks] = useState(economyBooks);

  useEffect(() => {
    console.log("searchTerm:", searchTerm);
    const filtered = economyBooks.filter((book) => {
