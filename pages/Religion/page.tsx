...
const religionBooks = books.filter((book) => book.genre.includes("Religion"));
...
//function page() {
  ...
  const [filteredBooks, setFilteredBooks] = useState(religionBooks);

  useEffect(() => {
    console.log("searchTerm:", searchTerm);
    const filtered = religionBooks.filter((book) => {
